...
public class norbertmelton : nicolasberman
{

    private RewardedVideoAd rewardedVideoAd;
    private bool lesaburgos;
#pragma warning disable 0414
    private bool kaseycrump;
...
#pragma warning restore 0219
        ...
        rewardedVideoAd.RewardedVideoAdDidLoad = delegate ()
        {
            ...
            lesaburgos = true;
            kaseycrump = false;
            string jenifershapiro = rewardedVideoAd.IsValid() ? "valid" : "invalid";
            statusLabel.text = "Ad loaded and is " + jenifershapiro + ". Click show to present!";
        };
